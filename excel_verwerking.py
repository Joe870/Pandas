...
def excel(input_paths, output_path):
    ...
    print(f'input_path(0):{input_paths[0]}')
    ...
    print(f'input_path(1):{input_paths[1]}')
    ...
    exact_relaties_df
    print(f'input_path(2):{input_paths[2]}')
    ...
    vendit_ingekocht_df
    print(f'input_path(4):{input_paths[4]}')
    ...
    print(f'input_paths(5):{input_paths[5]}')
    vendit_producten_df
